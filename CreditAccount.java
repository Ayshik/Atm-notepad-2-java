...
class Withdraw extends JFrame implements ActionListener
{
       ...
       public void updateInDB()
	{
		...
		String query = "SELECT `Password`,`Withdrawn`, `AccountNumber`, `AccountHolderName`, `Balance` FROM `users`;";   
                String query1 = "SELECT `Password`,`Withdrawn`, `AccountNumber`, `AccountHolderName`, `Balance` FROM `users`;";
